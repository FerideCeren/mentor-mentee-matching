...
def matching_two(mentee_choice, mentor_choice, uni_students, mentee_high, mentor_high, score, gender, ref_score, max_student, 
    ...
    for i in mentee_choice.keys():
        for j in mentor_choice.keys():
            problem += decision[i, j] <= decision[i, j]*score[(i,j)]
    ...
    for i in mentee_choice.keys():
        for j in mentor_choice.keys():
            problem += min_ref * decision[i, j] <= decision[i, j] * ref_score[i]
